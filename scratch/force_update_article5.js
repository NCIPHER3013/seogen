...
const publicUrls = [
  'https://jkfyyidrrjenvwdxljze.supabase.co/storage/v1/object/public/articles/seo-campaign/forklift_clean_cover_unbranded_1780835648604.png',
  'https://jkfyyidrrjenvwdxljze.supabase.co/storage/v1/object/public/articles/seo-campaign/forklift_clean_inline1_unbranded_1780835660040.png',
  'https://jkfyyidrrjenvwdxljze.supabase.co/storage/v1/object/public/articles/seo-campaign/forklift_clean_inline2_unbranded_1780835671663.png',
  'https://jkfyyidrrjenvwdxljze.supabase.co/storage/v1/object/public/articles/seo-campaign/forklift_clean_inline3_new_unbranded_1780853120574.png' // New image!
];
...
![การฉีดพ่นโฟมทำความสะอาดยางรถโฟล์คลิฟท์ชนิด Non-marking](${publicUrls[3]})
...
**A:** โดยปกติ การเช็ดทำความสะอาดจุดสัมผัสร่วม (พวงมาลัย, เบาะนั่ง) หลังจบกะ ควรเป็นหน้าที่ของ "พนักงานขับรถ" ส่วนการล้างใหญ่ (Deep Clean) ด้วยน้ำยาเคมีในพื้นที่ Wash Bay ควรเป็นหน้าที่ของ "ทีมทำความสะอาดเฉพาะทาง (Sanitation Team)" หรือเจ้าหน้าที่ซ่อมบำรุงที่ได้รับการฝึกอบรมเรื่องความปลอดภัยทางไฟฟ้าและเคมีแล้วครับ`;
  ...
  const newArticle = {
    id: 'forklift-clean-article5-fixed-' + Date.now(),
    ...
    images: [
      ...
      { url: publicUrls[3], type: 'inline3', alt: 'การฉีดพ่นโฟมทำความสะอาดยางรถโฟล์คลิฟท์ชนิด Non-marking' } // Updated
    ],
...
<head>
  <meta charset="UTF-8">
  <title>Force Update Article 5</title>
  <style>
...
<body>
  <div class="card">
    <h1>กำลังบังคับเขียนทับบทความที่ 5...</h1>
  ...
  <script>
    ...
    try {
      ...
      document.getElementById('status').innerText = '✅ บทความที่ 5 ถูกเขียนทับด้วยรูปล่าสุดเรียบร้อยแล้ว!';
  ...
  fs.writeFileSync('d:/SEOGEN/public/force-update-article5.html', htmlContent);
  console.log('Successfully wrote force-update-article5.html');
}
