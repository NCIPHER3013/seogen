...
const images = [
  'bakery_cover_unbranded_1779995996802.png',
  'bakery_inline1_unbranded_1779996011918.png',
  'bakery_inline2_unbranded_1779996033245.png',
  'bakery_inline3_unbranded_1779996048005.png'
];
...
<body>
  ...
  fs.writeFileSync('d:/SEOGEN/public/update-article6-final.html', htmlContent);
  console.log('Done!');
}
